...
func (c *commentsClient) CreateComment(ctx context.Context, in *CreateCommentRequest, opts ...grpc.CallOption) (*CreateCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/example.comments.pkg.api.comments.v1.Comments/CreateComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentsClient) GetComments(ctx context.Context, in *GetCommentsRequest, opts ...grpc.CallOption) (*GetCommentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/example.comments.pkg.api.comments.v1.Comments/GetComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Comments_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.comments.pkg.api.comments.v1.Comments/CreateComment",
	}
...
func _Comments_GetComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.comments.pkg.api.comments.v1.Comments/GetComments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Comments_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.comments.pkg.api.comments.v1.Comments",
